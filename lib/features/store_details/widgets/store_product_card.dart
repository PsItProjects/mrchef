...
class StoreProductCard extends GetView<StoreDetailsController> {
                  ...
                  children: [
                    ...
                    Flexible(
                      child: Column(
                        ...
                        children: [
                          Text(
                            controller.getTranslatedText(product['name']) ?? 'Special beef burger',
                          ...
                          Text(
                            CurrencyHelper.formatPrice(double.tryParse('${product['base_price'] ?? product['price'] ?? 16}') ?? 16.0),
