...
class EditProductScreen extends GetView<EditProductController> {
    ...
    return _SectionCard(
      ...
      child: Column(
        ...
        children: [
          ...
          // Existing Images
          Obx(() {
            if (controller.existingImages.isEmpty) return const SizedBox.shrink();
            return Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('current_images'.tr,
                    style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: AppColors.textMediumColor)),
                const SizedBox(height: 8),
                SizedBox(
                  height: 110,
                  child: ListView(
                    scrollDirection: Axis.horizontal,
                    children: controller.existingImages.asMap().entries.map((e) {
                      return _buildExistingImageThumb(e.value, e.key);
                    }).toList(),
                  ),
                ),
                const SizedBox(height: 12),
          ...
          Obx(() => SizedBox(
                ...
                child: ListView(
                  scrollDirection: Axis.horizontal,
                  children: [
                    if ((controller.existingImages.length + controller.selectedImages.length) < 10)
                      _buildAddImageBtn(),
  ...
  Widget _buildExistingImageThumb(String imageUrl, int index) {
    return Container(
      width: 110,
      height: 110,
        ...
        children: [
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Text('new'.tr, style: const TextStyle(color: AppColors.primaryColor, fontSize: 8, fontWeight: FontWeight.w700)),
            ),
          ),
          // Delete
          Positioned(
