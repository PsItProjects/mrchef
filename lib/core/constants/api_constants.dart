...
class ApiConstants {
  ...
  static const bool useProductionServer =
      true; // true = Production, false = Local
  ...
  static const String _localUrl =
      'http://192.168.1.8:8000/api'; // Physical device - Computer IP
  ...
  static const String categories =
      '/customer/shopping/categories'; // Public route
  static const String products = '/customer/shopping/products'; // Public route
  static const String kitchens =
      '/customer/shopping/kitchens'; // Main kitchens/restaurants endpoint
  static const String categoriesPageData =
  ...
  static String productReviews(int id) =>
      '/customer/shopping/products/$id/reviews';
  ...
  static String addKitchenToFavorites(int id) =>
      '/customer/shopping/favorites/kitchens/$id';
  static String removeKitchenFromFavorites(int id) =>
      '/customer/shopping/favorites/kitchens/$id';

  // Address endpoints
  static const String addresses = '/customer/profile/addresses';
  static String updateAddress(int id) => '/customer/profile/addresses/$id';
  static String deleteAddress(int id) => '/customer/profile/addresses/$id';
