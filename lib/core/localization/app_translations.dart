...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'en': {
      ...
      'customer_only_feature': 'This feature is only available for customers',
      ...
      'enter_commercial_registration': 'Enter your commercial registration number',
      'work_permit': 'Work permit',
      'work_permit_description': 'Copy of work permit,\nplease upload image file (JPG, PNG) or PDF',
      'id_or_passport': 'ID or passport number',
      'id_or_passport_description': 'ID or passport number of the store owner,\nplease upload image file (JPG, PNG) or PDF',
      'health_certificate': 'Health certificate',
      'health_certificate_description': 'Health certificate,\nplease upload image file (JPG, PNG) or PDF',
      'required_documents_warning': '⚠️ Required Documents',
      'required_documents_message': 'All three documents must be uploaded to complete registration',
      ...
      'product_images_hint': 'Add up to 10 images. First image will be the primary.',
      'add_image': 'Add Image',
      'primary': 'Primary',
      ...
      'image_requirements_details': '• Recommended size: 1080x1080 pixels (1:1 ratio)\n• Maximum file size: 5 MB\n• Supported formats: JPG, PNG\n• Use good lighting and clean background\n• Show the product clearly',
      ...
      'at_least_one_image_required': 'Please add at least one product image',
      'category_required': 'Please select a category',
      'invalid_price': 'Please enter a valid price',
      'invalid_preparation_time': 'Please enter a valid preparation time',
      'preparation_time_max_300': 'Preparation time cannot exceed 300 minutes (5 hours)',
      'calories_max_9999': 'Calories cannot exceed 9999',

      // API Error Messages (for translation)
      'Preparation time cannot exceed 300 minutes.': 'Preparation time cannot exceed 300 minutes (5 hours)',
      'The calories must not be greater than 9999.': 'Calories cannot exceed 9999',
      ...
      'price_modifier': 'Price Modifier',
      'price_modifier_hint': 'Positive to add, negative to subtract from base price',
      'group_name_required': 'Group name is required',
      'at_least_one_option_required': 'At least one option is required',
      'option_name_required': 'Option name is required',
      'min_selections_required_error': 'Min selections must be at least 1 when required',
      'max_selections_min_error': 'Max selections must be >= min selections',
      'max_selections_exceed_error': 'Max selections cannot exceed number of options',
      ...
      'set_opening_closing_hours': 'Set restaurant opening and closing hours',
      ...
      'restaurant_info_updated_successfully': 'Restaurant information updated successfully',
      'restaurant_info_update_failed': 'Failed to update restaurant information',
      ...
      'tap_to_select_location': 'Tap on the map to select your restaurant location',
      ...
      'configure_restaurant_hours': 'Configure your restaurant operating hours',
      'open': 'Open',
      'close': 'Close',
      'closed': 'Closed',
      ...
      'configure_notification_preferences': 'Configure your notification preferences',
      ...
      'merchant_dashboard_description': 'Manage your restaurant and track your business performance.',
      'coming_soon': 'Coming Soon',
      'merchant_features_coming_soon': 'Merchant features are currently under development. Stay tuned for exciting updates!',
      'upcoming_features': 'Upcoming Features',
      'menu_management': 'Menu Management',
      'menu_management_desc': 'Add, edit, and organize your restaurant menu items.',
      'order_management': 'Order Management',
      'order_management_desc': 'Track and manage incoming orders from customers.',
      'analytics_reports': 'Analytics & Reports',
      'analytics_reports_desc': 'View detailed insights about your business performance.',
      'restaurant_settings': 'Restaurant Settings',
      'restaurant_settings_desc': 'Configure your restaurant information and preferences.',
      'contact_support': 'Contact Support',
      'contact_support_message': 'Need help? Our support team is here to assist you.',
      ...
      'please_check_errors_below': 'Please check the errors below and try again',
      ...
      'app_description': 'Discover delicious meals from local restaurants and cafes. Order now and enjoy fast delivery with live tracking!',
    ...
    'ar': {
      ...
      'work_permit_description': 'نسخة من رخصة العمل،\nيرجى رفع ملف صورة (JPG, PNG) أو PDF',
      'id_or_passport': 'رقم الهوية أو جواز السفر',
      'id_or_passport_description': 'رقم الهوية أو جواز السفر لصاحب المتجر،\nيرجى رفع ملف صورة (JPG, PNG) أو PDF',
      'health_certificate': 'الشهادة الصحية',
      'health_certificate_description': 'الشهادة الصحية،\nيرجى رفع ملف صورة (JPG, PNG) أو PDF',
      'required_documents_warning': '⚠️ المستندات المطلوبة إلزامية',
      'required_documents_message': 'يجب رفع جميع المستندات الثلاثة لإكمال التسجيل',
      ...
      'product_images_hint': 'أضف حتى 10 صور. الصورة الأولى ستكون الرئيسية.',
      ...
      'at_least_one_image_required': 'الرجاء إضافة صورة واحدة على الأقل للمنتج',
      ...
      'preparation_time_max_300': 'وقت التحضير لا يمكن أن يتجاوز 300 دقيقة (5 ساعات)',
      'calories_max_9999': 'السعرات الحرارية لا يمكن أن تتجاوز 9999',

      // API Error Messages (for translation)
      'Preparation time cannot exceed 300 minutes.': 'وقت التحضير لا يمكن أن يتجاوز 300 دقيقة (5 ساعات)',
      'The calories must not be greater than 9999.': 'السعرات الحرارية لا يمكن أن تتجاوز 9999',
      'error_creating_product': 'خطأ في إنشاء المنتج',
      'error_updating_product': 'خطأ في تحديث المنتج',
      'failed_to_load_product': 'فشل في تحميل المنتج',
      'validation_error': 'الرجاء التحقق من البيانات المدخلة والمحاولة مرة أخرى',
      ...
      'min_selections_required_error': 'الحد الأدنى للاختيارات يجب أن يكون 1 على الأقل عندما يكون مطلوباً',
      'max_selections_min_error': 'الحد الأقصى للاختيارات يجب أن يكون >= الحد الأدنى',
      'max_selections_exceed_error': 'الحد الأقصى للاختيارات لا يمكن أن يتجاوز عدد الخيارات',
      ...
      'restaurant_info_updated_successfully': 'تم تحديث معلومات المطعم بنجاح',
      ...
      'configure_notification_preferences': 'تكوين تفضيلات الإشعارات الخاصة بك',
      ...
      'coming_soon': 'قريباً',
      'merchant_features_coming_soon': 'ميزات التاجر قيد التطوير حالياً. ترقبوا التحديثات المثيرة!',
      ...
      'contact_support_message': 'تحتاج مساعدة؟ فريق الدعم لدينا هنا لمساعدتك.',
      'contact_us': 'اتصل بنا',
      'close_dialog': 'إغلاق',
      'logout_confirmation': 'هل أنت متأكد من تسجيل الخروج؟',
      ...
      'please_check_errors_below': 'يرجى التحقق من الأخطاء أدناه والمحاولة مرة أخرى',
      ...
      'app_description': 'اكتشف أشهى الأطباق من المطاعم والمقاهي المحلية. اطلب الآن واستمتع بتوصيل سريع مع تتبع مباشر!',
      'restaurants': 'المطاعم',
      'users': 'المستخدمون',
      'orders': 'الطلبات',
