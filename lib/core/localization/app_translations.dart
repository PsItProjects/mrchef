...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'en': {
          ...
          'guest_login_message': 'Please login or create an account to access this feature',
          'guest_cart_message': 'Please login to add items to your cart and complete your order',
          'guest_favorites_message': 'Please login to save your favorite items',
          'guest_profile_message': 'Please login to access your profile and settings',
          'guest_address_message': 'Please login to manage your delivery addresses',
          'guest_checkout_message': 'Please login to complete your purchase',
          ...
          'processing_facebook_signup': 'Processing Facebook signup...',
          'processing_google_signup': 'Processing Google signup...',
          ...
          'new_otp_sent': 'A new OTP has been sent to your phone',
          'enter_valid_phone': 'Please enter a valid phone number',
          'processing_facebook_login': 'Processing Facebook login...',
          'processing_google_login': 'Processing Google login...',
          'search_coming_soon': 'Search functionality coming soon',
          'failed_to_load_orders': 'Failed to load orders',
          'reordering_items': 'Reordering items from',
          ...
          'opening_security_settings': 'Opening security settings...',
          'cache_cleared': 'App cache has been cleared successfully',
          'opening_app_store': 'Opening app store for rating...',
          'opening_share_dialog': 'Opening share dialog...',
          'opening_payment_methods': 'Opening payment methods...',
          ...
          'address_added': 'New address has been added successfully',
          ...
          'reviewed': 'Reviewed',
          'all_items_reviewed': 'All items have been reviewed',
          'review_next_item': 'Review Next Item',
          'would_you_like_to_review': 'Would you like to review',
          'no_thanks': 'No, Thanks',
          'discount': 'Discount',
          'offer': 'Offer',
          'deal': 'Deal',
          ...
          'account_deletion_post_logout_toast':
              'You have been logged out. Your account will be deleted within 30 days of inactivity.',
          ...
          'delivery_negotiable': 'Agreed upon delivery',
          'delivery_fee_type': 'Delivery Fee Type',
          'delivery_fee_negotiable': 'Agreed upon during order',
          'delivery_fee_free': 'Free delivery',
          'delivery_fee_fixed': 'Fixed delivery fee for all areas',
          'agreed_delivery_fee': 'Agreed Delivery Fee',
          'enter_delivery_fee': 'Enter delivery fee amount',
          'fast_food': 'Fast Food',
          ...
          'all_items_cleared': 'All items have been removed',
          'product_details': 'Product Details',
          'ingredients': 'Ingredients',
          'delicious_meal': 'A delicious meal prepared with care',
          ...
          'account_deletion_step1_title': 'Request account deletion',
          'account_deletion_step2_title': 'Verify with OTP',
          'account_deletion_notice_30_days': 'Your deletion request will be reviewed. The account will be deleted within 30 days of inactivity after the request is submitted.',
          'account_deletion_reason_optional': 'Reason (optional)',
          'account_deletion_reason_hint': 'Tell us why you want to delete your account (optional)',
          'account_deletion_next': 'Next',
          'account_deletion_enter_otp': 'Enter the 4-digit code',
          'account_deletion_enter_otp_hint': 'OTP code',
          'account_deletion_enter_otp_error': 'Please enter the 4-digit code',
          'account_deletion_submit': 'Submit request',
          ...
          // Unified Account & Profile Switching
          'switch_profile': 'Switch Profile',
          'switch_to_merchant': 'Switch to Merchant',
          'switch_to_merchant_desc': 'Manage your restaurant and orders',
          'switch_to_customer': 'Switch to Customer',
          'switch_to_customer_desc': 'Browse and order food',
          'become_merchant': 'Become a Merchant',
          'become_merchant_desc': 'Open your restaurant on the app',
          'complete_merchant_setup': 'Complete Merchant Setup',
          'complete_merchant_setup_desc': 'Finish setting up your restaurant',
          'switched_to_merchant': 'Switched to merchant mode',
          'switched_to_customer': 'Switched to customer mode',
          'switch_failed': 'Failed to switch profile',
          'merchant_activated': 'Merchant profile activated!',
          'merchant_activation_failed': 'Failed to activate merchant profile',
          'customer_account': 'Customer Account',
          'merchant_account': 'Merchant Account',
          'my_account': 'My Account',
          'view_order_history': 'View your order history',
          'manage_delivery_addresses': 'Manage your delivery addresses',
          'view_conversations': 'View your conversations',
          'profile_switch_success': 'Profile switched successfully',
          ...
          'enter_address_label': 'Enter address label',
          'label_required': 'Label is required for custom address type',
          ...
          'thank_you_for_review': 'Thank you for sharing your feedback with us.',
          ...
          'delete_review_confirmation': 'Delete Review?',
          ...
          'search_by_product_or_review': 'Search by product name or review text',
          ...
          'no_reviews_message': 'You haven\'t reviewed any products yet.',
          ...
          'max_images_message': 'You can add up to @count photos',
          ...
          'review_this_order': 'Review this order',
          ...
          'discount_fixed_price': 'Fixed Discount Price',
          ...
          'select_food_nationality': 'Select Food Nationality',
          'food_nationality_required': 'Please select a food nationality',
          'governorate': 'Governorate',
          'select_governorate': 'Select Governorate',
          ...
          'order_status_awaiting_confirmation': 'Awaiting Confirmation',
          'order_status_cancelled': 'Cancelled',
          'order_status_rejected': 'Rejected',
          'no_orders': 'No orders found',
          'confirm_order': 'Confirm Order',
          'confirm_delivery': 'Confirm Delivery',
          'confirm_delivery_message': 'Please confirm that you have received your order. After confirmation, you can rate the products.',
          ...
          'reject': 'Reject',
          'accept_price_confirmation': 'Are you sure you want to accept this price? The order will be confirmed.',
          'reject_price_confirmation': 'Are you sure you want to reject this price? The order will return to pending status.',
          'price_accepted_successfully': 'Price accepted successfully',
          'price_rejected_successfully': 'Price rejected successfully',
          'price_proposal_pending': 'The merchant has proposed a price for your order. Please review and accept or reject.',
          'price_proposal_title': 'Price Proposal',
          ...
          'report_conversation_hint': 'Tell us what happened. We will review this conversation.',
          ...
          'report_closed': 'This report is closed',
          'get_help': 'Get help',
          'about_app': 'About App',
          ...
          'location_information_desc': 'Please provide your business location details',
          'pick_location_from_map': 'Pick Location from Map',
          ...
          'manage_discount_codes': 'Create and manage discount codes',
          ...
          'enter_coupon_title_ar': 'Enter coupon title in Arabic',
          'enter_coupon_title_en': 'Enter coupon title in English',
          'description_ar': 'Description (Arabic)',
          'description_en': 'Description (English)',
          'enter_description_ar': 'Enter description in Arabic',
          'enter_description_en': 'Enter description in English',
          ...
          'coupon_active_description': 'Customers can use this coupon',
          'coupon_inactive_description': 'Coupon is disabled',
          'no_coupons_yet': 'No Coupons Yet',
          'no_coupons_description': 'Create your first discount code to attract more customers',
        ...
        'ar': {
          ...
          'guest_login_message': 'يرجى تسجيل الدخول أو إنشاء حساب للوصول إلى هذه الميزة',
          'guest_cart_message': 'يرجى تسجيل الدخول لإضافة المنتجات للسلة وإتمام طلبك',
          'guest_favorites_message': 'يرجى تسجيل الدخول لحفظ منتجاتك المفضلة',
          'guest_profile_message': 'يرجى تسجيل الدخول للوصول إلى ملفك الشخصي والإعدادات',
          'guest_address_message': 'يرجى تسجيل الدخول لإدارة عناوين التوصيل',
          'guest_checkout_message': 'يرجى تسجيل الدخول لإتمام عملية الشراء',
          ...
          // Toast Messages
          'failed_to_load_store_details': 'فشل في تحميل تفاصيل المطعم',
          'added_to_favorites': 'تم إضافته إلى المفضلة',
          'removed_from_favorites': 'تم إزالته من المفضلة',
          'failed_to_update_favorites': 'فشل في تحديث المفضلة',
          'cannot_open_chat': 'لا يمكن فتح المحادثة',
          'adding_to_cart': 'يتم إضافة المنتج للسلة...',
          'failed_to_add_to_cart': 'فشل في إضافة المنتج إلى السلة',
          'processing_signup': 'جاري معالجة التسجيل...',
          'agree_to_terms': 'يرجى الموافقة على الشروط والأحكام',
          'processing_facebook_signup': 'جاري التسجيل عبر فيسبوك...',
          'processing_google_signup': 'جاري التسجيل عبر جوجل...',
          'enter_complete_otp': 'يرجى إدخال رمز التحقق كاملاً',
          'phone_not_found': 'رقم الهاتف غير موجود',
          'welcome_back': 'مرحباً بعودتك!',
          'account_created_successfully': 'تم إنشاء حسابك بنجاح!',
          'new_otp_sent': 'تم إرسال رمز تحقق جديد إلى هاتفك',
          'enter_valid_phone': 'يرجى إدخال رقم هاتف صحيح',
          'processing_facebook_login': 'جاري تسجيل الدخول عبر فيسبوك...',
          'processing_google_login': 'جاري تسجيل الدخول عبر جوجل...',
          'search_coming_soon': 'ميزة البحث قريباً',
          'failed_to_load_orders': 'فشل في تحميل الطلبات',
          'reordering_items': 'إعادة طلب العناصر من',
          'dark_mode_enabled': 'تم تفعيل الوضع الداكن',
          'dark_mode_disabled': 'تم إلغاء الوضع الداكن',
          'currency_changed_to': 'تم تغيير العملة إلى',
          'failed_to_update_language': 'فشل في تحديث اللغة',
          'network_error': 'حدث خطأ في الشبكة',
          'opening_notification_settings': 'جاري فتح إعدادات الإشعارات...',
          'opening_security_settings': 'جاري فتح إعدادات الأمان...',
          'cache_cleared': 'تم مسح ذاكرة التطبيق بنجاح',
          'opening_app_store': 'جاري فتح المتجر للتقييم...',
          'opening_share_dialog': 'جاري فتح نافذة المشاركة...',
          'opening_payment_methods': 'جاري فتح طرق الدفع...',
          'address_deleted': 'تم حذف العنوان بنجاح',
          'failed_to_delete_address': 'فشل في حذف العنوان',
          'address_set_default': 'تم تعيينه كعنوان افتراضي',
          'failed_to_set_default': 'فشل في تعيين العنوان الافتراضي',
          'address_updated': 'تم تحديث العنوان بنجاح',
          'address_added': 'تم إضافة العنوان الجديد بنجاح',
          'failed_change_language': 'فشل في تغيير اللغة',
          ...
          'feedback': 'ملاحظات',
          'report': 'تقرير',
          'invalid_order_id': 'رقم الطلب غير صالح',
          ...
          'reviewed': 'تم التقييم',
          'all_items_reviewed': 'تم تقييم جميع العناصر',
          'review_next_item': 'تقييم العنصر التالي',
          'would_you_like_to_review': 'هل ترغب في تقييم',
          'no_thanks': 'لا، شكراً',
          'discount': 'خصم',
          'offer': 'عرض',
          'deal': 'صفقة',
          ...
          'account_deletion_post_logout_toast':
              'تم تسجيل خروجك وسيتم حذف الحساب خلال 30 يوم من عدم النشاط.',
          ...
          'delivery_negotiable': 'توصيل بالاتفاق',
          'delivery_fee_type': 'نوع رسوم التوصيل',
          'delivery_fee_negotiable': 'يتم الاتفاق عليها أثناء الطلب',
          'delivery_fee_free': 'توصيل مجاني',
          'delivery_fee_fixed': 'مبلغ توصيل ثابت لجميع الأماكن',
          'agreed_delivery_fee': 'رسوم التوصيل المتفق عليها',
          'enter_delivery_fee': 'أدخل مبلغ رسوم التوصيل',
          ...
          'added_to_cart_success': 'تمت الإضافة إلى السلة بنجاح!',
          'clear_cart': 'مسح السلة',
          'clear_cart_confirm': 'هل أنت متأكد من مسح جميع العناصر من السلة؟',
          'cancel': 'إلغاء',
          'clear': 'مسح',
          'order_details': 'تفاصيل الطلب',
          'size_label': 'الحجم',
          'additions_label': 'الإضافات',
          'special_notes': 'ملاحظات خاصة',
          'item_total': 'إجمالي العنصر',
          'all_items_cleared': 'تم مسح جميع العناصر',
          'product_details': 'تفاصيل المنتج',
          'ingredients': 'المكونات',
          'delicious_meal': 'وجبة لذيذة محضرة بعناية',
          ...
          'account_deletion_step1_title': 'طلب حذف الحساب',
          'account_deletion_step2_title': 'التحقق عبر رمز التحقق',
          'account_deletion_notice_30_days': 'سيتم مراجعة طلب حذف الحساب، وسيتم حذف الحساب خلال 30 يومًا من عدم النشاط بعد إرسال الطلب.',
          'account_deletion_reason_optional': 'السبب (اختياري)',
          'account_deletion_reason_hint': 'اكتب سبب حذف الحساب (اختياري)',
          'account_deletion_next': 'التالي',
          'account_deletion_enter_otp': 'أدخل رمز التحقق المكون من 4 أرقام',
          'account_deletion_enter_otp_hint': 'رمز التحقق',
          'account_deletion_enter_otp_error': 'يرجى إدخال رمز التحقق المكون من 4 أرقام',
          'account_deletion_submit': 'إرسال الطلب',
          ...
          // الحساب الموحد وتبديل الملف الشخصي
          'switch_profile': 'تبديل الملف الشخصي',
          'switch_to_merchant': 'التبديل إلى التاجر',
          'switch_to_merchant_desc': 'إدارة مطعمك وطلباتك',
          'switch_to_customer': 'التبديل إلى العميل',
          'switch_to_customer_desc': 'تصفح واطلب الطعام',
          'become_merchant': 'كن تاجراً',
          'become_merchant_desc': 'افتح مطعمك على التطبيق',
          'complete_merchant_setup': 'أكمل إعداد التاجر',
          'complete_merchant_setup_desc': 'أكمل إعداد مطعمك',
          'switched_to_merchant': 'تم التبديل إلى وضع التاجر',
          'switched_to_customer': 'تم التبديل إلى وضع العميل',
          'switch_failed': 'فشل تبديل الملف الشخصي',
          'merchant_activated': 'تم تفعيل حساب التاجر!',
          'merchant_activation_failed': 'فشل تفعيل حساب التاجر',
          ...
          'profile_switch_success': 'تم تبديل الملف الشخصي بنجاح',
          'profile_switch_failed': 'فشل تبديل الملف الشخصي',
          ...
          'chat_with_restaurant': 'محادثة مع المطعم',
          ...
          'work_address': 'العمل',
          'other_address': 'أخرى',
          'address_label': 'كنية العنوان',
          'enter_address_label': 'أدخل كنية العنوان',
          'label_required': 'كنية العنوان مطلوبة لنوع العنوان المخصص',
          ...
          'thank_you_for_review': 'شكراً لمشاركة رأيك معنا.',
          ...
          'delete_review_confirmation': 'حذف التقييم؟',
          'delete_review_warning': 'لا يمكن التراجع عن هذا الإجراء.',
          'failed_to_delete_review': 'فشل حذف التقييم',
          'edit_your_review': 'عدّل تقييمك',
          'update_review': 'تحديث التقييم',
          'search_reviews': 'البحث في التقييمات',
          'search_by_product_or_review': 'ابحث باسم المنتج أو نص التقييم',
          ...
          'no_reviews_message': 'لم تقم بتقييم أي منتج بعد.',
          ...
          'category': 'التصنيف',
          'spicy': 'حار',
          'food_nationality': 'نوع المطبخ',
          'governorate': 'المحافظة',
          'select_cuisine': 'اختر نوع المطبخ',
          'select_governorate': 'اختر المحافظة',
          'prep_time': 'وقت التحضير',
          'max_prep_time': 'أقصى وقت تحضير',
          'minutes': 'د',
          'featured_only': 'المميزة فقط',
          'most_popular': 'الأكثر شعبية',
          'trending_searches': 'البحث الرائج',
          'search_hint': 'ابحث عن أكل، مطاعم...',
          'suggestions_for': 'اقتراحات',
          'product_suggestion': 'منتج',
          'restaurant_suggestion': 'مطعم',
          'category_suggestion': 'تصنيف',
          'cuisine_suggestion': 'مطبخ',
          ...
          'discount_fixed_price': 'السعر الثابت بعد الخصم',
          ...
          'check_back_later': 'تحقق لاحقاً للمنتجات الجديدة',
          ...
          'select_food_nationality': 'اختر جنسية الطعام',
          'food_nationality_required': 'الرجاء اختيار جنسية الطعام',
          'governorate': 'المحافظة',
          'select_governorate': 'اختر المحافظة',
          'governorate_required': 'الرجاء اختيار المحافظة',
          'search': 'بحث...',
          'no_results_found': 'لا توجد نتائج',
          ...
          'order_status_awaiting_confirmation': 'بانتظار تأكيد العميل',
          'order_status_cancelled': 'ملغي',
          'order_status_rejected': 'مرفوض',
          'no_orders': 'لا توجد طلبات',
          'confirm_order': 'تأكيد الطلب',
          'confirm_delivery': 'تأكيد الاستلام',
          'confirm_delivery_message': 'يرجى تأكيد استلام طلبك. بعد التأكيد، يمكنك تقييم المنتجات.',
          ...
          'reject': 'رفض',
          'accept_price_confirmation': 'هل أنت متأكد من قبول هذا السعر؟ سيتم تأكيد الطلب.',
          'reject_price_confirmation': 'هل أنت متأكد من رفض هذا السعر؟ سيعود الطلب إلى حالة الانتظار.',
          'price_accepted_successfully': 'تم قبول السعر بنجاح',
          'price_rejected_successfully': 'تم رفض السعر بنجاح',
          'price_proposal_pending': 'قام التاجر باقتراح سعر لطلبك. يرجى المراجعة والقبول أو الرفض.',
          'price_proposal_title': 'اقتراح السعر',
          ...
          'report_conversation': 'إبلاغ عن المحادثة',
          'report_conversation_hint': 'اشرح لنا ما الذي حدث. سنقوم بمراجعة هذه المحادثة.',
          'report_reason': 'السبب',
          'report_details_optional': 'تفاصيل (اختياري)',
          ...
          'admin_responded': 'تم الرد من الإدارة',
          'report_closed': 'هذا البلاغ مغلق',
          ...
          'fees_and_pricing': 'الرسوم والتسعير',
          'service_fee_label': 'رسوم الخدمة',
          'enter_delivery_fee': 'أدخل رسوم التوصيل',
          'enter_service_fee': 'أدخل رسوم الخدمة',
          'sar': 'ر.س',
          ...
          'location_information_desc': 'يرجى تقديم تفاصيل موقع عملك',
          'pick_location_from_map': 'اختر الموقع من الخريطة',
          'complete_onboarding': 'إكمال التسجيل',
          'latitude_required': 'خط العرض مطلوب',
          'longitude_required': 'خط الطول مطلوب',
          'invalid_latitude': 'خط عرض غير صحيح (يجب أن يكون بين -90 و 90)',
          'invalid_longitude': 'خط طول غير صحيح (يجب أن يكون بين -180 و 180)',
          'address_ar': 'العنوان (عربي)',
          ...
          'manage_discount_codes': 'إنشاء وإدارة أكواد الخصم',
          ...
          'enter_coupon_title_ar': 'أدخل عنوان الكوبون بالعربي',
          'enter_coupon_title_en': 'أدخل عنوان الكوبون بالإنجليزي',
          'description_ar': 'الوصف (عربي)',
          'description_en': 'الوصف (إنجليزي)',
          'enter_description_ar': 'أدخل الوصف بالعربي',
          'enter_description_en': 'أدخل الوصف بالإنجليزي',
          ...
          'min_order_amount': 'أقل مبلغ للطلب',
          'applies_to': 'ينطبق على',
          'all_products': 'جميع المنتجات',
          'specific_products': 'منتجات محددة',
          'usage_limits': 'حدود الاستخدام',
          'max_uses_total': 'أقصى عدد استخدامات',
          'max_uses_per_customer': 'أقصى استخدام لكل عميل',
          'unlimited': 'غير محدود',
          'validity_period': 'فترة الصلاحية',
          'start_date': 'تاريخ البداية',
          'end_date': 'تاريخ الانتهاء',
          'not_set': 'غير محدد',
          'coupon_active': 'الكوبون فعال',
          'coupon_active_description': 'يمكن للعملاء استخدام هذا الكوبون',
          'coupon_inactive_description': 'الكوبون معطل',
          'no_coupons_yet': 'لا توجد كوبونات',
          'no_coupons_description': 'أنشئ أول كود خصم لجذب المزيد من العملاء',
          ...
          'error_toggling_coupon': 'خطأ في تغيير حالة الكوبون',
          'discount_off': 'خصم',
